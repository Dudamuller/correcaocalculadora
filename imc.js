...
calcBtn.addEventListener("click", (e) => {
  ...
  console.log("Peso:", weight, "Altura:", height); // Debugging
  ...
  console.log("IMC Calculado:", imc); // Debugging
  ...
  if (!info) {
      imcNumber.innerText = "Indefinido";
      imcInfo.innerText = "Por favor, insira valores válidos.";
      return;
  }
